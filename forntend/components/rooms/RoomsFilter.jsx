    ...
    <section className='filter-container'>
      ...
      <form className='filter-form'>
        ...
        <div className='form-group'>
          ...
          <select className='form-control' onChange={(e) => roomTypeFiltering(e.target.value)} defaultValue='all' name='type' id='type'>
        ...
        <div className='form-group'>
          ...
          <input className='form-control' type='range' name='price' id='price' min={100} max={1000} defaultValue={1000} onChange={(e) => roomPriceFiltering(e.target.value)} />
        </div>
        {/* room price end */}
        ...
        <div className='form-group'>
          ...
          <div className='single-extra'>
            <input name='breakfast' type='checkbox' id='breakfast' checked={allowBreakfast} onChange={() => setAllowBreakfast(!allowBreakfast)} />
            <label htmlFor='breakfast'>breakfast</label>
          </div>

          {/* pets checked */}
          <div className='single-extra'>
            <input type='checkbox' name='pets' id='pets' checked={allowPets} onChange={() => setAllowPets(!allowPets)} />
