...
function ProfileEditModal({ editProfileModal, setEditProfileModal }) {
  ...
  return (
    <Modal title='Edit Profile Information' open={editProfileModal} onOk={() => setEditProfileModal(false)} onCancel={() => setEditProfileModal(false)} footer={[]} width={800}>
      {fetchLoading ? (
        <Loading />
      ) : fetchError ? (
        ...
        <Form form={form} className='login-form' name='create-new-user' onFinish={onFinish} layout='vertical'>
          ...
          >
            <Input prefix={<UserOutlined className='site-form-item-icon' />} placeholder='Full Name' size='large' type='text' allowClear />
          </Form.Item>
          ...
          >
            <Input prefix={<PhoneOutlined className='site-form-item-icon' />} placeholder='Phone' size='large' type='text' allowClear />
          </Form.Item>
          ...
          >
            <DatePicker style={{ width: '100%' }} placeholder='Pick your Date Of Birth' format='YYYY-MM-DD' size='large' allowClear />
          </Form.Item>
          ...
          >
            <Input prefix={<EnvironmentOutlined className='site-form-item-icon' />} placeholder='Address' size='large' type='text' allowClear />
          </Form.Item>

          <Form.Item>
            <Button className='login-form-button mt-4' htmlType='submit' type='primary' size='large' loading={loading} disabled={loading}>
              Update Info
            </Button>
          </Form.Item>
        </Form>
